...
export const metadata = {
  title: 'Privacy Policy - KBPipe',
  description: 'How KBPipe handles your data and protects your privacy.',
};
      ...
      <div className="w-full max-w-2xl">
        <div className="rounded-2xl bg-white shadow-xl shadow-gray-200/50 p-8 sm:p-10 space-y-8">
          ...
          <p className="text-sm leading-relaxed text-gray-600">
            KBPipe is committed to protecting your privacy. This policy explains what data we collect,
            how we use it, and the rights you have over your information.
          </p>

          {/* Data Collected */}
          <Section icon={Database} title="Data We Collect">
            <p>We collect and store the following information when you use KBPipe:</p>
          ...
          <Section icon={Globe} title="How Data Is Processed">
            ...
            <p>We do not sell your data to any third party. Data is shared with the above services solely to provide the core functionality of KBPipe.</p>
          </Section>
          ...
          <Section icon={Cookie} title="Cookie Usage">
            <p>
              KBPipe uses <strong>essential cookies only</strong>. We use Supabase authentication cookies
