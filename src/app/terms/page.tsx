...
export const metadata = {
  title: 'Terms of Service - KBPipe',
  description: 'Terms and conditions for using KBPipe.',
};
      ...
      <div className="w-full max-w-2xl">
        <div className="rounded-2xl bg-white shadow-xl shadow-gray-200/50 p-8 sm:p-10 space-y-8">
          ...
          <p className="text-sm leading-relaxed text-gray-600">
            By using KBPipe, you agree to these terms. Please read them carefully before using the service.
          </p>

          {/* Service Description */}
          <Section icon={FileText} title="Service Description">
            <p>
              KBPipe is a web application that converts video recordings into structured knowledge base
          ...
          <Section icon={UserCheck} title="User Responsibilities">
            <p>As a user of KBPipe, you agree to:</p>
          ...
          <Section icon={Lightbulb} title="Intellectual Property">
            <p>
              ...
              videos, and articles produced by the service remain your intellectual property. KBPipe does
              not claim ownership over any content you create or process through the service.
            </p>
            <p>
              The KBPipe application, its design, branding, and underlying technology are owned by
              KBPipe and its licensors.
            </p>
          </Section>
          ...
          <Section icon={AlertTriangle} title="Limitation of Liability">
            <p>
              KBPipe is provided &ldquo;as is&rdquo; without warranties of any kind, express or implied.
              We do not guarantee the accuracy, completeness, or reliability of AI-generated content.
            </p>
            <p>
              To the maximum extent permitted by law, KBPipe shall not be liable for any indirect,
          ...
          <Section icon={Server} title="Service Availability">
            <p>
              We strive to keep KBPipe available at all times, but we do not guarantee uninterrupted access.
